...
def add_note():
    input_data = input(
        Fore.BLUE + 'Write your notes right here and press "Enter" when you are done:' + Fore.GREEN + '\n>>>' + Style.RESET_ALL)

    new_note = NoteRecord()
    new_note.note_data = input_data

    particles_note = new_note.note_data.split(" ")
    new_note.note_keyword: str = 'No keyword (phrase).' if len(particles_note) == 0 else str(
        random.choices(particles_note, k=1))
    print(Fore.BLUE + "\n{:*^40}\n".format("Your note have random keyword") + Style.RESET_ALL)

    while True:
        input_data = input(
            Fore.BLUE + 'Would you like to assign a tag?\nInput next: ' + Fore.GREEN + 'yes' + Fore.BLUE + '/' + Fore.RED + 'no' + Fore.GREEN + '\n>>>' + Style.RESET_ALL)
    ...
    input_data_2 = input(
        Fore.BLUE + 'Would you like to save your note in stream? ' + Fore.GREEN + 'yes' + Fore.BLUE + '/' + Fore.RED + 'no' + Fore.GREEN + '\n>>>' + Style.RESET_ALL)
    if input_data_2 == 'yes':
...
def find_in_note():
    input_data = input(
        Fore.BLUE + 'Please, input the phrase, you want to de finded:' + Fore.GREEN + '\n>>>' + Style.RESET_ALL)
    matches_id_list = []
    match_counter = 0
...
def delete_note():
    input_data = input(
        Fore.BLUE + 'Please, input the note ID, you want to de burned:' + Fore.GREEN + '\n>>>' + Style.RESET_ALL)
...
def change_note():
    while True:
        input_data = input(
            Fore.BLUE + 'Please, input the note ID, you want to de changed:' + Fore.GREEN + '\n>>>' + Style.RESET_ALL)
        if input_data in NOTEBASE.keys():
            input_data_2 = input(Fore.BLUE + 'Please, input new content:' + Fore.GREEN + '\n>>>' + Style.RESET_ALL)
            if input(
                    Fore.BLUE + 'You sure, you want to save changes? ' + Fore.GREEN + 'yes' + Fore.BLUE + '/' + Fore.RED + 'no' + Fore.GREEN + '\n>>>' + Style.RESET_ALL) == "yes":
...
def clear_tags():
    while True:
        input_data = input(
            Fore.BLUE + 'Please, input the note ID, to clear ALL tags: ' + Fore.GREEN + '\n>>>' + Style.RESET_ALL)
        if input_data in NOTEBASE.keys():
            if input(
                    Fore.BLUE + 'You sure, you want to delete tags? ' + Fore.GREEN + 'yes' + Fore.BLUE + '/' + Fore.RED + 'no' + Fore.GREEN + '\n>>>' + Style.RESET_ALL) == "yes":
...
def find_tag_notes():
    input_data = input(
        Fore.BLUE + 'Please, input the tag, you want to de finded:' + Fore.GREEN + '\n>>>' + Style.RESET_ALL)
    matches_id_list = []
    match_counter = 0
